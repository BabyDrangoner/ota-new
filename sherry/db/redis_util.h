 ...
 * @return 1 成功，0 失败
 */
int redis_set_key_value(const std::string& key, const std::string& value, int expire_seconds = 0);
 ...
 * @return 1 成功，0 失败
 */
int redis_reset_value(const std::string& key, const std::string& value, int expire_seconds = 0);
